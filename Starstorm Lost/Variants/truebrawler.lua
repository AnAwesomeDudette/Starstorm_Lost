callback.register("postLoad", function()
	if modloader.checkFlag("ssl_truebrawler") then--[]
		...
		SurvivorVariant.setLoadoutSkill(newVariant, "Three-Hit Jab Combo", "Z->Z->Z to peform a fast three-hit combination attack. The final hit &b&stuns enemies&!& for &y&125% damage.&!&", sprSkills, 6)

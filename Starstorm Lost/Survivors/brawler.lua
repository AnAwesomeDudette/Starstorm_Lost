...
Brawler:addCallback("useSkill", function(player, skill)
	...
	if not playerData.skin_fullSkillOverride then --brawler is so complicated i felt he deserved the ability to have all of his skills overwritten
